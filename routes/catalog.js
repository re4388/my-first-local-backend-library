...
Routes that act on some specific resource (e.g. book) use path parameters to get the object id 
from the URL.
*/
...
//index page
//get and post request for create, delete, update, list one book, list all books
...
//get and post request for create, delete, update, list one and list all
