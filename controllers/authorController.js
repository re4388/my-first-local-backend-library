...
exports.author_create_post = [
    ...
    // Validate fields.
    // use the optional() function to run a subsequent validation 
    // only if a field has been entered (this allows us to validate optional fields).
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            // Unlike with the Genre post handler, we don't check whether the Author object already 
            // exists before saving it. Arguably we should, though as it is now we can have multiple 
        ...
        var author = new Author(
            {
                ...
                date_of_birth: req.body.date_of_birth,
                date_of_death: req.body.date_of_death,
                _id: req.params.id //update author, we do this o.w a new ID will be assigned
            });
